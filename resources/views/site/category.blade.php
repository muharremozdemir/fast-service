...
<!-- Ana kategoriler -->
<div class="container-fluid main-category-container">
    <div class="row">
        <div class="col">
            <div class="main-category-links">
                @foreach($parents as $p)
                    <a class="main-category-link {{ $currentParent->id === $p->id ? 'active' : '' }}"
                       href="{{ route('site.category', ['parent' => $p->slug]) }}">
                        {{ $p->name }}
                    </a>
                @endforeach
            </div>
...
<!-- Alt kategoriler -->
<div class="container-fluid sub-category-container">
    <div class="row">
        <div class="col">
            <div class="sub-category-links">
                @forelse($currentParent->children as $child)
                    <a class="sub-category-link {{ optional($currentChild)->id === $child->id ? 'active' : '' }}"
                       href="{{ route('site.category', ['parent' => $currentParent->slug, 'child' => $child->slug]) }}">
                        {{ $child->name }}
                    </a>
                @empty
...
<div class="container">
    <div class="row">
        <div class="col">
            <h2 class="category-content-title">
                {{ optional($currentChild)->name ?? $currentParent->name }}
            </h2>
        </div>
    </div>
    ...
    @else
        {{-- <div class="row product-cards-row">
            @for ($i = 0; $i < 4; $i++)
                <div class="col-4 col-md-3">
                    <div>
                        <a class="product-card" href="{{ route('site.product') }}">
                            <button class="btn product-card-add-to-cart">
                                <img width="24" height="24" src="{{ asset('site/assets/img/plus-icon.svg') }}" alt="">
                            </button>
                            <img class="product-card-image" src="{{ asset('site/assets/img/product-img-1.jpg') }}" alt="">
                            <h3 class="product-card-title">Örnek Ürün</h3>
                            <p class="product-card-text">Açıklama</p>
