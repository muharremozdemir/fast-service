...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/fastservice.css">
    <link rel="stylesheet" href="./assets/css/responsive-sm.css">
    <link rel="stylesheet" href="./assets/css/responsive-md.css">
    <link rel="stylesheet" href="./assets/css/responsive-lg.css">
</head>
<body>
        ...
        <div class="row">
            <div class="col-3">
                <div class="d-flex align-items-center justify-content-start gap-2">
                    <a href="./category.html" class="btn btn-light btn-fastservice">
            ...
            <div class="col-3">
                <div class="header-right d-flex align-items-center justify-content-end">
                    <a href="./cart.html" class="btn btn-light btn-fastservice">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="row">
        <div class="col-12">
            <div class="order-complete-card p-5">
                ...
                <p class="text-muted m-0">Siparişiniz başarıyla tamamlandı. Kısa süre içerisinde teslim edilecektir.</p>
