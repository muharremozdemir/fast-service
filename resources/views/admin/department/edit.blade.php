...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <!--begin::Title-->
            <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Departman Düzenle</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">Departman Düzenle</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <!--begin::Form-->
        <form id="kt_department_form" class="form" action="{{ route('admin.departments.update', $department->id) }}" method="POST">
            @csrf
            @method('PUT')
                    ...
                    <div class="card-body pt-0">
                        <div class="row mb-10">
                            ...
                            <div class="col-md-6 fv-row mb-7">
                                ...
                                <input type="text" name="name" class="form-control form-control-solid @error('name') is-invalid @enderror" placeholder="Departman adını girin (örn: Mutfak, Teknik)" value="{{ old('name', $department->name) }}" required />
                                @error('name')
                            ...
                            <div class="col-md-6 fv-row mb-7">
                                ...
                                <div class="d-flex gap-5">
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input" type="radio" name="is_active" id="is_active_1" value="1" {{ old('is_active', $department->is_active) == '1' ? 'checked' : '' }} />
                                        <label class="form-check-label" for="is_active_1">
                                            Aktif
                                        </label>
                                    </div>
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input" type="radio" name="is_active" id="is_active_0" value="0" {{ old('is_active', $department->is_active) == '0' ? 'checked' : '' }} />
                        ...
                        <div class="row mb-10">
                            ...
                            <div class="col-12 fv-row mb-7">
                                ...
                                <textarea name="description" class="form-control form-control-solid @error('description') is-invalid @enderror" rows="4" placeholder="Departman açıklamasını girin">{{ old('description', $department->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                @foreach($staff as $user)
                                    <div class="col-md-6 col-lg-4 mb-5 staff-item" data-staff-name="{{ strtolower($user->name) }}">
                                        <div class="form-check form-check-custom form-check-solid form-check-lg">
                                            <input class="form-check-input" type="checkbox" name="users[]" value="{{ $user->id }}" id="user_{{ $user->id }}" {{ (old('users') ? in_array($user->id, old('users')) : in_array($user->id, $selectedUsers)) ? 'checked' : '' }} />
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <div id="selected_staff_summary" class="text-muted fs-7">
                                        @php
                                            $selectedStaff = $staff->whereIn('id', old('users', $selectedUsers));
                                        @endphp
                                        @if($selectedStaff->count() > 0)
                                            <div class="d-flex flex-wrap gap-2">
                                                @foreach($selectedStaff as $user)
