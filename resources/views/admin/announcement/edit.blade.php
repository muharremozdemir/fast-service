...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <!--begin::Title-->
            <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Duyuru Düzenle</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">Duyuru Düzenle</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <!--begin::Form-->
        <form id="kt_announcement_form" class="form" action="{{ route('admin.announcements.update', $announcement->id) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="title" class="form-control form-control-solid @error('title') is-invalid @enderror" placeholder="Duyuru başlığını girin" value="{{ old('title', $announcement->title) }}" required />
                            @error('title')
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="hidden" name="content" id="content_input" value="{{ old('content', $announcement->content) }}" required />
                            @error('content')
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="datetime-local" name="published_at" class="form-control form-control-solid @error('published_at') is-invalid @enderror" value="{{ old('published_at', $announcement->published_at ? $announcement->published_at->format('Y-m-d\TH:i') : date('Y-m-d\TH:i')) }}" />
                            @error('published_at')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-5">
                            <div class="form-check form-check-custom form-check-solid">
                                <input class="form-check-input" type="radio" name="is_active" id="is_active_1" value="1" {{ old('is_active', $announcement->is_active) == '1' ? 'checked' : '' }} />
                                <label class="form-check-label fw-semibold" for="is_active_1">
                                    Aktif
                                </label>
                            </div>
                            <div class="form-check form-check-custom form-check-solid mt-3">
                                <input class="form-check-input" type="radio" name="is_active" id="is_active_0" value="0" {{ old('is_active', $announcement->is_active) == '0' ? 'checked' : '' }} />
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Set initial content
        var initialContent = {!! json_encode(old('content', $announcement->content)) !!};
