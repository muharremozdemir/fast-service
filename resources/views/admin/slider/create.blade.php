...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <!--begin::Title-->
            <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Yeni Slider Ekle</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">Yeni Slider</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <!--begin::Form-->
        <form id="kt_slider_form" class="form" action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="title" class="form-control form-control-solid @error('title') is-invalid @enderror" placeholder="Slider başlığını girin" value="{{ old('title') }}" required />
                            @error('title')
                        ...
                        <!--begin::Görsel-->
                        <div class="fv-row mb-7">
                            <label class="required form-label fw-semibold fs-6 mb-2">Görsel</label>
                            <div class="d-flex flex-column">
                                ...
                                <!--end::Image preview-->
                                <!--begin::File input-->
                                <input type="file" name="image" id="image_input" class="form-control form-control-solid @error('image') is-invalid @enderror" accept="image/*" required />
                                <!--end::File input-->
                                @error('image')
