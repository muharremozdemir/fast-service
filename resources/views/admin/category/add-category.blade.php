...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <!--begin::Form-->
        <form id="kt_category_form" class="form d-flex flex-column flex-lg-row" action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="name" class="form-control mb-2 @error('name') is-invalid @enderror" placeholder="Kategori adını girin" value="{{ old('name') }}" required />
                            <!--end::Input-->
                            @error('name')
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="4" placeholder="Kategori açıklamasını girin">{{ old('description') }}</textarea>
                            <!--end::Input-->
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            @enderror
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Maksimum dosya boyutu: 2MB. İzin verilen formatlar: JPG, JPEG, PNG</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Input group-->
                    </div>
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="number" name="sort_order" class="form-control @error('sort_order') is-invalid @enderror" placeholder="0" value="{{ old('sort_order', 0) }}" min="0" />
                            <!--end::Input-->
                            @error('sort_order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
