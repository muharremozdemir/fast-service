								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_66b9a24c634f9">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_66b9a24c634f9" data-allow-clear="true">
																<option></option>
											...
											<div class="card card-flush py-4">
												...
												<div class="card-header">
													...
													<div class="card-toolbar">
														<div class="rounded-circle {{ $category->is_active ? 'bg-success' : 'bg-danger' }} w-15px h-15px" id="kt_ecommerce_add_category_status"></div>
													</div>
												</div>
												<!--end::Card header-->
												...
												<div class="card-body pt-0">
													<!--begin::Select2-->
													<select name="is_active" class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select status">
														<option value="1" {{ old('is_active', $category->is_active) == 1 ? 'selected' : '' }}>Published</option>
														<option value="0" {{ old('is_active', $category->is_active) == 0 ? 'selected' : '' }}>Unpublished</option>
													</select>
													<!--end::Select2-->
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body pt-0">
													...
													<div class="mb-10 fv-row">
														...
														<!--end::Label-->
														<!--begin::Input-->
														<input type="text" name="category_name" class="form-control mb-2" placeholder="Product name" value="{{ old('name', $category->name ?? '') }}"  />
														<!--end::Input-->
														<!--begin::Description-->
													...
													<div>
														...
														<!--end::Label-->
														<!--begin::Editor-->
														<textarea id="kt_ecommerce_add_category_description" name="description" class="form-control min-h-200px mb-2">{{ old('description', $category->description ?? '') }}</textarea>													
													...
													<div class="mb-10 fv-row">
														...
														<!--end::Label-->
														<!--begin::Input-->
														<input type="text" name="slug" class="form-control mb-2" placeholder="Category slug" value="{{ old('slug', $category->slug ?? '') }}" />
														<!--end::Input-->
														<!--begin::Description-->
														<div class="text-muted fs-7">URL'de görünen kısa isim. Otomatik oluşur, istersen manuel de değiştirebilirsin.</div>
														<!--end::Description-->
													</div>
													<!--end::Input group-->
												</div>
											...
											{{-- <div class="card card-flush py-4">
												...
												<div class="card-body pt-0">
													...
													<div class="mb-10">
														...
														<!--end::Label-->
														<!--begin::Editor-->
														<textarea id="kt_ecommerce_add_category_meta_description" name="meta_description" class="form-control min-h-100px mb-2"></textarea>
														<!--end::Editor-->
														<!--begin::Description-->
