...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <!--begin::Title-->
            <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Yeni Personel Ekle</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">Yeni Personel</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <!--begin::Form-->
        <form id="kt_staff_form" class="form" action="{{ route('admin.staff.store') }}" method="POST">
            @csrf
                    ...
                    <div class="card-body pt-0">
                        <div class="row mb-10">
                            ...
                            <div class="col-md-6 fv-row mb-7">
                                ...
                                <input type="email" name="email" class="form-control form-control-solid @error('email') is-invalid @enderror" placeholder="kullanici@example.com" value="{{ old('email') }}" required />
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-10">
                            ...
                            <div class="col-md-6 fv-row mb-7">
                                ...
                                <input type="text" name="phone" class="form-control form-control-solid @error('phone') is-invalid @enderror" placeholder="05xxxxxxxxx" value="{{ old('phone') }}" required />
                                @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-5">
                            ...
                            <div class="alert alert-info d-flex align-items-center p-5 mb-0">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span>Bu kullanıcı otomatik olarak seçtiğiniz roller ile oluşturulacak ve sistem özelliklerine erişim sağlayacaktır. Roller aşağıdan seçilebilir. Giriş yaparken telefon numarasına SMS ile doğrulama kodu gönderilecektir.</span>
                                </div>
                            </div>
                            <!--end::Info Box-->
                        </div>
