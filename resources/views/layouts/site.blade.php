...
<div class="container">
    <div class="row category-row">
        <div class="col-6 col-md-3">
            <div>
                <a href="{{ route('site.category') }}" class="category-card">
                    <img class="category-card-icon" src="{{ asset('site/assets/img/room-service-icon.svg') }}" alt="">
                    <h2 class="category-card-title">
                        Oda Servisi
                    </h2>
                    <p class="category-card-text">
                        Yemek & İçecek<br>Siparişleri
                    </p>
                </a>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div>
                <a href="{{ route('site.category') }}" class="category-card">
                    <img class="category-card-icon" src="{{ asset('site/assets/img/hotel-services-icon.svg') }}" alt="">
                    <h2 class="category-card-title">
                        Otel Hizmetleri
                    </h2>
                    <p class="category-card-text">
                        Havlu,<br>Temizlik vb.
                    </p>
                </a>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div>
                <a href="{{ route('site.category') }}" class="category-card">
                    <img class="category-card-icon" src="{{ asset('site/assets/img/failure-notification-icon.svg') }}" alt="">
                    <h2 class="category-card-title">
                        Arıza Bildirimi
                    </h2>
                    <p class="category-card-text">
                        TV, klima, <br>lamba vb.
                    </p>
                </a>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div>
                <a href="{{ route('site.category') }}" class="category-card">
                    <img class="category-card-icon" src="{{ asset('site/assets/img/reception-contact-icon.svg') }}" alt="">
                    <h2 class="category-card-title">
                        Resepsiyon İletişim
                    </h2>
                    <p class="category-card-text">
                        Resepsiyona <br>mesaj bırak
                    </p>
                </a>
            </div>
        </div>
